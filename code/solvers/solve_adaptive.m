function [Xout,Uout,elapsed_time,Ntotal,Ncount] = solve_adaptive(bparams,mparams)
...
%        Ntotal - sum number of gridpoints used over all timesteps
%        Ncount - number of timesteps
