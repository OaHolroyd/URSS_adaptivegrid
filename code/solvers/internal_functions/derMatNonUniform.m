function D = derMatNonUniform(ord,acc,X,L)
...
switch ord
    ...
    case 2
        switch acc
            case 1
                ...
                return
            case 2
                v_2 = 2*(2*H1 - H0 + H2)./H_1./(H0 + H1 + H_1)./(H0 + H1 + H_1 + H2);
                v_1 = 2*(H0 - 2*H1 - H2 + H_1)./H_1./(H0 + H1)./(H0 + H1 + H2);
                v1 = -2*(2*H0 - H1 - H2 + H_1)./H2./(H0 + H1)./(H0 + H1 + H_1);
                v2 = 2*(2*H0 - H1 + H_1)./H2./(H0 + H1 + H2)./(H0 + H1 + H_1 + H2);
                ...
                % diagonals
                D = spdiags([v_2,v_1,v1,v2],[-2,-1,1,2],N,N);
    ...
    case 3
        switch acc
            case 2
                v_2 = (6*(H0 - 2*H1 - H2))./(H_1.*(H0 + H_1).*(H0 + H1 + H_1).*(H0 + H1 + H2 + H_1));
                v_1 = -(6*(H0 - 2*H1 - H2 + H_1))./(H0.*H_1.*(H0 + H1).*(H0 + H1 + H2));
                v0 = (6*(2*H0 - 2*H1 - H2 + H_1))./(H0.*H1.*(H1 + H2).*(H0 + H_1));
                v1 = -(6*(2*H0 - H1 - H2 + H_1))./(H1.*H2.*(H0 + H1).*(H0 + H1 + H_1));
                v2 = (6*(2*H0 - H1 + H_1))./(H2.*(H1 + H2).*(H0 + H1 + H2).*(H0 + H1 + H2 + H_1));
    ...
    case 4
        switch acc
            ...
            case 2
                ...
                return
            case 3
                v_3 = (24*(H0.^2 + 3*H1.^2 + H2.^2 - 6*H0.*H1 - 4*H0.*H2 - 2*H0.*H3 + 4*H1.*H2 + 2*H1.*H3 + H2.*H3 + H0.*H_1 - 3*H1.*H_1 - 2*H2.*H_1 - H3.*H_1))./(H_2.*(H_1 + H_2).*(H0 + H_1 + H_2).*(H0 + H1 + H_1 + H_2).*(H0 + H1 + H2 + H_1 + H_2).*(H0 + H1 + H2 + H3 + H_1 + H_2));
                v_2 = (24*(6*H0.*H1 - 3*H1.^2 - H2.^2 - H0.^2 + 4*H0.*H2 + 2*H0.*H3 - 4*H1.*H2 - 2*H1.*H3 - H2.*H3 - H0.*H_1 - H0.*H_2 + 3*H1.*H_1 + 3*H1.*H_2 + 2*H2.*H_1 + 2*H2.*H_2 + H3.*H_1 + H3.*H_2))./(H_1.*H_2.*(H0 + H_1).*(H0 + H1 + H_1).*(H0 + H1 + H2 + H_1).*(H0 + H1 + H2 + H3 + H_1));
                v_1 = (24*(H0.^2 + 3*H1.^2 + H2.^2 + H_1.^2 - 6*H0.*H1 - 4*H0.*H2 - 2*H0.*H3 + 4*H1.*H2 + 2*H1.*H3 + H2.*H3 + 2*H0.*H_1 + H0.*H_2 - 6*H1.*H_1 - 3*H1.*H_2 - 4*H2.*H_1 - 2*H2.*H_2 - 2*H3.*H_1 - H3.*H_2 + H_1.*H_2))./(H0.*H_1.*(H0 + H1).*(H_1 + H_2).*(H0 + H1 + H2).*(H0 + H1 + H2 + H3));
                v0 = -(24*(3*H0.^2 + 3*H1.^2 + H2.^2 + H_1.^2 - 9*H0.*H1 - 6*H0.*H2 - 3*H0.*H3 + 4*H1.*H2 + 2*H1.*H3 + H2.*H3 + 4*H0.*H_1 + 2*H0.*H_2 - 6*H1.*H_1 - 3*H1.*H_2 - 4*H2.*H_1 - 2*H2.*H_2 - 2*H3.*H_1 - H3.*H_2 + H_1.*H_2))./(H0.*H1.*(H1 + H2).*(H0 + H_1).*(H1 + H2 + H3).*(H0 + H_1 + H_2));
                ...
                % diagonals
                D = spdiags([v_3,v_2,v_1,v0,v1,v2,v3],[-3,-2,-1,0,1,2,3],N,N);
